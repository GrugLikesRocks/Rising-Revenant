...
export function defineContractComponents(world: World) {
  return {
	  ...
	  GameEntityCounter: (() => {
	    return defineComponent(
	      world,
	      { game_id: RecsType.Number, revenant_count: RecsType.Number, outpost_count: RecsType.Number, event_count: RecsType.Number, outpost_exists_count: RecsType.Number },
	      {
	        metadata: {
	  ...
	  Reinforcement: (() => {
	    return defineComponent(
	      world,
	      { game_id: RecsType.Number, owner: RecsType.String, balance: RecsType.Number },
	      {
	        metadata: {
	          name: "Reinforcement",
	          types: [],
