        ...
        <div className="summon-revenant-page-container" style={{ backgroundImage: backgroundImage }}>
            <ClickWrapper className="main-content">
                ...
                <div className="amount-section">
                    ...
                    {ownReveants.length === max && <div className="button-style-prep-phase" onMouseDown={() => { setMenuState(PrepPhaseStages.BUY_REIN) }}>Maximum number of revenants have<br />been summoned for this demo <br />Click to continue</div>}
                </div>
            </ClickWrapper>
            <div className="footer-text" >1 Revenant = {revenantCost} $LORDS</div>
        </div>
